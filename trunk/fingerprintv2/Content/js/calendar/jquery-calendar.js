...
var popUpCal = {
    ...
    connectCalendar: function(target) {
        ...
        if (this.autoPopUp == 'button' || this.autoPopUp == 'both') { // pop-up calendar when button clicked
            $input.wrap('<span class="calendar_wrap"></span>').
				...
				this.buttonImage + '" alt="' + this.buttonText + '" title="' + this.buttonText + '" width="32px" height="32px" style="cursor:pointer;"/>' :
				'<button class="calendar_trigger">' + (this.buttonImage != '' ?
				'<img src="' + this.buttonImage + '" alt="' + this.buttonText + '" title="' + this.buttonText + '" width="32px" height="32px" style="cursor:pointer;" />' :
    ...
    setupActions: function() {
        ...
        $('.calendar_daysRow td a').each(function() {// select day
            $(this).click(function() {
