                                            ...
                                            <tr>
                                                <td class="left_td">
                                                    <div style="padding: 2px 0px 0x 10px">
                                                        -
                                                        <a style="cursor: pointer; font-weight:bold;" class="leftstyle1_2" id="a_user">User
                                                        </a>
                                                    </div>
                                                    <div style="padding: 2px 0px 0x 10px">
                                                        - <a style="cursor: pointer;" class="leftstyle1_2" id="a_group">Group
                                                        </a>
                                                    </div>
                                                    <div style="padding: 2px 0px 0x 10px">
                                                        -
                                                        <a style="cursor: pointer;" class="leftstyle1_2" id="a_customer">Customer
                                                        </a>   
                                                    </div>
                                                    <br />
                                                </td>
